...
class EnhancedGmailClient:
    ...
    @with_retry(
        max_attempts=3,
        retry_exceptions=(HttpError, GmailError)
    )
    def search_messages(
        self,
    ...
    def get_message(self, message_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.rate_limiter.on_error()
            raise GmailError(error_msg, details={"message_id": message_id, "status_code": e.resp.status})
    ...
    def extract_csv_attachments(
        ...
        attachment_regex: Optional[str] = None
    ...
    @with_retry(
        max_attempts=2,  # Be more conservative with sending emails
