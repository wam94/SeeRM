...
from app.core.config import get_settings, validate_required_settings, print_configuration_summary
...
def test_csv(ctx, csv_path: str, top_movers: int, output: Optional[str]):
    ...
    try:
        ...
        console.print(f"Changed accounts: {digest_dict.get('stats', {}).get('changed_accounts', 0)}")
