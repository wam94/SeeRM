...
from app.core.exceptions import WorkflowError, ConfigurationError
from app.core.models import ProcessingResult, WorkflowType, ProcessingStatus
...
class WeeklyDigestWorkflow:
    ...
    def digest_service(self):
        ...
        if self._digest_service is None:
            self._digest_service = create_digest_service(
                self.gmail_client,
                self.settings
            )
        ...
        try:
            ...
            health_results = {
                ...
                "overall_status": "healthy" if all(
                    ...
                    for h in [gmail_health, digest_health]
                ) else "unhealthy"
            }
