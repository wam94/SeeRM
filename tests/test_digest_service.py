...
class TestPerformanceBenchmarks:
    ...
    def test_csv_parsing_performance(self, benchmark_data):
        ...
        try:
            ...
            assert parse_time < benchmark_data["csv_parse_time_ms"] * 2, f"CSV parsing too slow: {parse_time:.2f}ms"
    ...
    def test_digest_generation_performance(self, benchmark_data):
        ...
        assert gen_time < benchmark_data["digest_gen_time_ms"] * 2, f"Digest generation too slow: {gen_time:.2f}ms"
