"""Notion helpers for SeeRM artifacts and company context."""
...
class NotionContextFetcher:
    ...
    def get_company_context(self, callsign: str) -> Optional[CompanyContext]:
        ...
        owners = _first_people(props, ["Owner", "Owners"])
    ...
    def _fetch_news_highlights(self, company_page: dict, props: dict) -> List[NewsHighlight]:
        ...
        # 1) News in the relation property.
        ...
        # 1b) If no relation property, query intel DB directly.
        ...
        # 2) Inline blocks under a "News" heading, if present.
